...
router.post('/carrito/:idProducto', authTokenAndRole(['cliente', 'admin']), addProductToCartController);
router.delete('/carrito/:idProducto', authTokenAndRole(['cliente', 'admin']), removeProductFromCartController);
...
router.post('/fav/:idProducto', authTokenAndRole(['cliente', 'admin']), addProductToFavController);
router.delete('/fav/:idProducto', authTokenAndRole(['cliente', 'admin']), removeProductFromFavController);
